...
const Medics = () => {
  ...
  const [selectedMedic, setSelectedMedic] = useState<typeof medics[0] | null>(null);

  const ViewMedicModal = ({ medic, onClose }: { medic: typeof medics[0] | null, onClose: () => void }) => {
        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <h4 className="font-semibold mb-2 text-gray-700">Professional Status</h4>
              <div className="flex items-center space-x-2">
                ...
                <span className={`
                  font-medium
                  ${medic.status === 'available' ? 'text-green-600' : 'text-red-600'}
                `}>
